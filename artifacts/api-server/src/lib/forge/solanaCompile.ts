 ...
 * then generates the real IDL via `anchor idl build`. `buildDir` should be
 * reused across repair/harden attempts for the same project so incremental
 * compilation keeps subsequent attempts fast; the caller owns its cleanup.
 */
